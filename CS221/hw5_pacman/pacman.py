...
To play your first game, type 'uv run pacman.py' from the command line.
...
def read_command(argv):
    ...
    usage_str = """
  USAGE:      uv run pacman.py <options>
  EXAMPLES:   (1) uv run pacman.py
                  - starts an interactive game
              (2) uv run pacman.py --layout small_classic --zoom 2
              OR  uv run pacman.py -l small_classic -z 2
